...
window.PORTFOLIO_PROJECTS = [
  {
    ...
    tech: ['TypeScript', 'Vite', 'Web Audio API', 'Dexie', 'PWA'],
...
window.TECH_HIGHLIGHT = ['React', 'TypeScript', 'Python', 'Claude AI', 'PWA', 'Next.js', 'Vue 3', 'Tone.js', 'MediaPipe', 'WebGL2', 'WebGPU', 'Dexie'];
